  ...
  return (
    <div className="flex h-screen bg-background text-foreground">
      ...
      <div className="w-2/3 p-4 flex flex-col items-center justify-center space-y-4">
        <h2 className="text-xl font-bold mb-4">{game.replace(/_/g, ' ')}</h2>
